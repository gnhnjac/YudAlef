...
class ServerApp(wx.Dialog):
    ...
    def ClientConnection(self,conn,addr):
        ...
        self.aes_cypher = AESCipher(hashlib.sha256(int_to_bytes(self.private_key)).digest())
    ...
    def DecodeMsg(self,msg):
        return self.aes_cypher.decrypt(msg).decode()

    def EncodeMsg(self,msg):
        return self.aes_cypher.encrypt(msg)
